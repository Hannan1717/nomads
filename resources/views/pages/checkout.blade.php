            ...
            <div class="row">
                  ...
                  <div class="card card-details mb-3">
                                 ...
                                 <tr>
                                    <td>
                                       <img src="https://ui-avatars.com/api/?name={{ $detail->username }}"
                                          class="rounded-circle" alt="" height="60" />
                                    </td>
                     ...
                     <div class="member mt-3">
                        ...
                        <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                           ...
                           <input required type="text" class="form-control mb-2 mr-sm-2" style="width: 50px"
                              name="nationality" placeholder="Nationality" />

                           <label class="sr-only" class="mr-2" for="is_visa">Preference</label>
                           <select required class="custom-select mb-2 mr-sm-2" name="is_visa">
                           ...
                           <div class="input-group mb-2 mr-sm-2">
                              <input type="text" class="form-control datepicker" style="width: 150px" required
               ...
               <div class="col-lg-4">
                  ...
                  <div class="join-container">
                     <a href="{{ route('checkout-success', $item->id) }}" class="btn btn-block btn-join-now mt-3 py-2">I
                        Have Made
                        Payment</a>
                  </div>
